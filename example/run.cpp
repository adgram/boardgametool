...
// g++ run.cpp -o run.exe -lshlwapi -lstdc++ -mwindows
...
// char to wchar_t
//---------------------------------------------------------------------
std::wstring Run::Ansi2Unicode(const char *text)
{
...
//---------------------------------------------------------------------
bool Run::CheckEnviron(const wchar_t *rtp)
{
    // init: _args, _argv
    LPWSTR *argvw;
    int argc;
    ...
    // init: _pystand (full path of Run.exe)
...
// run string
//---------------------------------------------------------------------
int Run::RunString(const wchar_t *script)
{
    if (_Py_Main == NULL) {
        return -1;
    }
...
// run ansi string
//---------------------------------------------------------------------
int Run::RunString(const char *script)
{
...
// LoadScript()
//---------------------------------------------------------------------
int Run::DetectScript()
{
    // init: _script (init script like Run.int or Run.py)
