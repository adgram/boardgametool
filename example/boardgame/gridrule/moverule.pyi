...
class MoveHistory:
    ...
    def serialize(self, current = None) -> list:
        """序列化历史记录树结构"""
        ...

    @classmethod
    def deserialize(cls, data: list, head_begin = False) -> 'MoveHistory':
        """反序列化历史记录"""
        ...
...
class MoveCallback:
    def __init__(self):
        ...
        self.start_clock: Callable = lambda player_name: ...
        self.over_clock: Callable = lambda player_name: ...
        self.move_site: Callable = lambda player_name, pt: ...
        self.move_point_0_0: Callable = None
        self.move_point_0_1: Callable = None
        self.move_point_1_0: Callable = None
        self.move_point_0_2: Callable = None
        self.move_point_2_0: Callable = None
        self.move_point_1_1: Callable = None
        self.move_point_1_2: Callable = None
        self.move_point_2_1: Callable = None
        self.move_point_2_2: Callable = None
...
class MoveManager():
    ...
    @property
    def callback(self) -> MoveCallback: ...

    def set_history(self, history: MoveHistory): ...
    
    def reset(self, in_race, is_over, with_clock, matr, pts_map):
        ...

    # def set_callback(self, matr): ...
