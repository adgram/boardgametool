from ...gridrule import (MatrixP, PlayerManager, LinePositionEnum,
                      AxisEnum, CanvasGrid, PieceUi, GameData, MoveRuleEnum, RegionPoints,
                      PieceColor, NeighborTable, MoveManager, Direction, GameOverEnum,
...
class Player_六人跳棋(PlayerManager):
    ...
    def player_df(self, name, value):
        """玩家"""
        piece = self.piece_define(None, movable = [MoveRuleEnum.Move], value = value)
...
class Game_六人跳棋(GameData):
    ...
    def init_gridattr(self):
        ...
        return {'matr': MatrixP.simple_matrix((17, 17), region, neighbortable)}
...
class App_六人跳棋(Application):
    ...
    def init_grid(self):
        return CanvasGrid(size = (17, 17), canvas_size = (800, 800), origin = (18, 0),
